...
mod tests {
    ...
    fn validate_signature_success() {
        ...
        //println!("{:#?}",msg_bytes);
        let outcome = verify_signature(&pub_key.unwrap(),&signature,(serde_json::to_string(&msg).unwrap()).as_bytes());
